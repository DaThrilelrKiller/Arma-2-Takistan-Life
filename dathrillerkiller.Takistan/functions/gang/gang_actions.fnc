...

{
	...
	_x addaction ["Capture Flag","noscript.sqf",format ['["SERVER",[player,(player call gang_name),%1,"capture"],"S_gang_capture",true,false]call network_MPExec;',_x],1,false,true,"",format[' !pickingup && {getpos %1 select 2 < 0}',_x]];
