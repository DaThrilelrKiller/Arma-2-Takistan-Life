...
{
format['if (player distance %1 < 5 or player == %1)then {[%1]execVM "FUNCTIONS\ITEMS\IDcard.sqf";};',player]call network_broadcast;
...
_background ctrlSetText format["data\images\Faces\%1ID.paa",_PlayerSide];
