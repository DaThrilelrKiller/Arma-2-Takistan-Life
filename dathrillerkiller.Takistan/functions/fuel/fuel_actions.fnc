...

{
	...
	_x addaction ["","noscript.sqf",'call fuel_fill;',25,false,true,"LeanRight","player distance _target < 5 && {!([_target,'Pump Fuel (E)','data\images\tags\Gas pump']call tag_show)} && {v_fuel_cost < v_fuel_max}"];
