...
_is = ["Bread", "rabbit", "boar", "medikit", "lighter", "fishingpole", "Pickaxe"];
...
_es = ["Binocular", "NVGoggles", "GPS","Fuelline","medikit","lockpick","NVGoggles","reparaturkit","lighter","Fuelline","kanister","GPS","Binocular","supgrade"];
...
[gasstation2,["Gas pump","Gas N Pit"],dummyobj,dummyobj,_fs,_fs,true,{true}],
[gasstation3,["Gas pump","Gas N Chips"],dummyobj,dummyobj,_fs,_fs,true,{true}],
[gasstation4,["Gas pump","Gas N Go"],dummyobj,dummyobj,_fs,_fs,true,{true}],
[gasstation5,["Gas pump","Mikes Gas"],dummyobj,dummyobj,_fs,_fs,true,{true}],
...
[petshop,["","Pet Shop"],dummyobj,dummyobj,_petShop,_petShop,true,{true}],
...
[southsupermarket,["Rifle","Gun Shop"],gunbox2,dummyobj,_gs,_gs,true,{true}]
];